...
def run_ml_app():
    ...
    loaded_model = load_model("C:/Users/abina/Downloads/dpcode/codefordesignproject/models/diabetes_model.pkl")
    ...
    with st.expander("Predicted Results"):
        ...
        if prediction == 1:
            ...
            st.subheader(
                f"You are Likely to have diabetics, we estimated there is {round(pred_prob[0][1] * 100, 4)}% of chance of you having diabteics")
